...
- **How the Waveshare board attaches to `WaveShare_Mounting_Plate` is undocumented upstream.**
  Raised 2026-09-08 when the printed plate was test-fitted (it fits the base and is fine). The
