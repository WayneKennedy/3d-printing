...
| 2026-09-07 ~07:11 | `soarm_plate1_nosupport.gcode` | 6 h 04 est | SO-ARM101 follower plate 1 of 4: `Base_motor_holder`, `Motor_holder_Base` (clean reprint), `Motor_holder_Wrist`, `WaveShare_Mounting_Plate`. White PLA+, **no supports** — all four measure under 2 % overhang area. 61.7 g. Started 01:07, ran overnight with the camera effectively blind, so watched on telemetry only. |
