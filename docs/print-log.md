...
**Times are UTC** (the workstation monitor's clock; printhub itself runs Europe/London, BST =
UTC+1 in summer). Verified for rows from 2026-09-21 on; earlier rows are assumed UTC, unchecked.
...
| 2026-09-21 20:18 | `bee35_gps_220.gcode` | 46 min of 47 est. | **Complete; usable.** SpeedyBee Bee35 GPS mount `220.stl`, unmodified, for the Matek M10Q-5883; first real TPU part. Printed standing on its original +Y face, no supports, `tpu` profile. Board seats and is held by three of four lugs; **the top lug printed into air** (needed an organic tree from the bed); owner expects the connector plug to hold that edge. [open-questions.md](open-questions.md#tpu-95a--profile-and-calibration) |
| 2026-09-22 00:45 | `h743_deck_revc.gcode` | 176.1 min of 180 est. | **Complete — "perfect" (owner).** wk-drones Holybro 10" FC deck **rev C** — floating TPU platform on four Z-flexure arms, modelled 2026-09-21 in CadQuery (wk-drones `1b11e03`) with arms drawn 1.9 and hex bores 4.85 AF (untested). Printed upside down, no support, `tpu` profile. 5.87 m = 17.1 g against a sliced 17.05. First layers photographed by the owner: platform, arms, bars and hex bores as modelled. **4.85 AF hex takes the 4.55 AF brass standoff by hand and needs pliers to remove** (one pillar tried) — the press-fit works; see [decisions.md](decisions.md#materials). Not yet reported: arm widths (~2.0 expected), M2 fit in the Ø2.4 FC holes. |
| 2026-09-23 13:40 | `gf_bp_4x4.gcode` | 0 min of 137 est. | **Aborted in the heat-soak by the owner; nothing extruded.** Gridfinity 4 × 4 baseplate test ([open-questions.md](open-questions.md#desk-gridfinity-and-opengrid--all-12-plates-printed-2026-09-25)). Started by the assistant on a readiness report ("bed clear and black PETG loaded") when the plates are decided white — the owner did not want 2 h spent on a wrong-colour test. The cancel queued behind `M190` as [AGENTS.md](../AGENTS.md#aborting) warns (state stayed `printing`, bed still climbing); cleared with `emergency_stop` + `firmware_restart`. |
| 2026-09-23 15:02 | `vesa_v2.gcode` | 68.0 min of 67.9 est. | **Complete; first layer "silky smooth", print "looks good" (owner).** VESA 100 plate for printhub's Pi (metal case) and touchscreen on an arm — owner's own model `vesa_v2.stl`, 110 × 110 × 3 mm flat skeletal frame. **Black PETG from the tail of a spool unused for years** — no sign of moisture (no popping reported, clean surface). `petg`, Debian 2.5.0, `--center 104,123`, skirt only, no brim; footprint X 45–163 Y 64–182, in mesh. 3.59 m against a sliced 10.9 g. |
| 2026-09-23 17:34 | `gf_bp_4x4.gcode` | 135 min of 137 est. | **Complete; owner: "looks ok" mid-print, not yet inspected off the bed.** Desk Gridfinity plate 1 of 12 — thin 4 × 4 (168 mm, 5 mm, no magnets), Gridfinity Rebuilt `910e22d`. **White PETG**, `petg`, Debian 2.5.0, `--center 104,123`, skirt only; footprint X 16–192 Y 35–211. 8.4 m. Becomes one of the two middle plates ([open-questions.md](open-questions.md#desk-gridfinity-and-opengrid--all-12-plates-printed-2026-09-25)). Time breakdown used for the speed work: 68 % perimeters, solid infill at 20 mm/s. |
| 2026-09-23 19:49 | `gf_bp_4x4_petg_fast.gcode` | 91 min of 86 est. (+6 %) | **Complete; first print on `petg_fast`. Owner: "indistinguishable from plate 1".** Desk Gridfinity plate 2, thin 4 × 4, white PETG — same STL as plate 1, **2 h 15 m → 1 h 31 m (−33 %)**, 8.4 m. The estimate under-read by 6 % where `petg` over-reads by 1–2 % — expect `petg_fast` estimates to run short. Profile and the `M204` flavour fix: [decisions.md](decisions.md#slicing). Just after completion printhub stopped answering TCP (Moonraker, SSH) for ~2 min while `tailscale ping` still worked; no reboot, load 0.08, no wlan/OOM journal lines — cause unknown. |
| 2026-09-24 01:02 | `gf_bin_4x2x3_petg_fast.gcode` | 194 min of 189 est. (+3 %) | **Complete; fit "perfect" on plates 1 and 2, including straddling the join (owner).** Gridfinity Rebuilt standard bin 4 × 2 × 3 (167.5 × 83.5 × 24.6 mm), one compartment, stock label tab (40.7 × 14.5 mm face), scoop, stacking lip, no holes. White PETG, `petg_fast`, skirt only; footprint X 19–189 Y 80–166. 23.0 m. First bin — the fit test for plates 1 and 2. |
| 2026-09-24 09:00 | `gf_bp_4x4_petg_fast.gcode` | 91 min | **Complete.** Desk Gridfinity plate 3 of 12 (first outer plate), thin 4 × 4, white PETG, `petg_fast`; identical run to plate 2 (1 h 31 m, 8.4 m). |
| 2026-09-24 12:08 | `gf_bp_4x4_petg_fast.gcode` | 91 min | **Complete.** Desk Gridfinity plate 4 of 12, thin 4 × 4, white PETG, `petg_fast`; identical to plates 2–3 (8.4 m). |
| 2026-09-24 14:48 | `gf_bp_4x4_petg_fast.gcode` | 91 min | **Complete.** Desk Gridfinity plate 5 of 12, thin 4 × 4, white PETG, `petg_fast`; identical to plates 2–4 (8.4 m). |
| 2026-09-24 16:26 | `gf_bp_4x4_petg_fast.gcode` | 91 min | **Complete.** Desk Gridfinity plate 6 of 12, thin 4 × 4, white PETG, `petg_fast`; identical to plates 2–5 (8.4 m). |
| 2026-09-24 18:27 | `gf_bp_4x4_petg_fast.gcode` | 91 min | **Complete.** Desk Gridfinity plate 7 of 12, thin 4 × 4, white PETG, `petg_fast`; identical to plates 2–6 (8.4 m). |
| 2026-09-24 20:17 | `gf_bp_4x4_petg_fast.gcode` | 91 min | **Complete.** Desk Gridfinity plate 8 of 12, thin 4 × 4, white PETG, `petg_fast`; identical to plates 2–7 (8.4 m). |
| 2026-09-24 22:07 | `gf_bp_4x4_petg_fast.gcode` | 91 min | **Complete.** Desk Gridfinity plate 9 of 12, thin 4 × 4, white PETG, `petg_fast`; identical to plates 2–8 (8.4 m). |
| 2026-09-25 05:13 | `gf_bin_4x2x9_div2_petg_fast.gcode` | 337 min of 327 est. (+3 %) | **Complete; not yet inspected.** Gridfinity Rebuilt 4 × 2 × 9 bin (167.5 × 83.5 × 63 mm) with one divider (`divx=2`) → two 2 × 2 pockets, stock tabs flush with the rim, **no stacking lip** (first no-lip bin), no holes. White PETG, `petg_fast`, skirt only; footprint X 19–189 Y 80–166. 36.5 m. Overnight, unattended; the height gauge for desk bins. |
