...
- **Holybro 10" FC deck, rev C** — **printing 2026-09-21 at the owner's request** (rev B is
  ...
  `1b11e03`. `h743_deck_revc.gcode`: upside down (`--rotate-x 180`), no support, 3 h 00, 17.1 g. A 38 × 56 × 5 mm platform carrying the FC hangs on four Z-shaped flexure arms
