...
| SSH | `ssh wkenn@printhub` (Tailscale SSH; password auth disabled) |
| Default filament | White PETG — 240 °C nozzle / 80 °C bed |
| Slice + print | `ssh wkenn@printhub '~/slicer/slice-print.sh <model> petg [--print]'` |

## Documents

| File | Contents |
|---|---|
| [CLAUDE.md](CLAUDE.md) | Operating instructions for AI sessions working on this printer |
...
| [docs/backlog.md](docs/backlog.md) | Open items and deferred decisions |
| `reference/` | Snapshots of the live files on the Pi (taken 2026-09-01) |
